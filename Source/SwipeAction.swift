...
@objc public enum SwipeActionStyle: Int {
...
public class SwipeAction: NSObject {
    ...
    @objc public var style: SwipeActionStyle
    ...
    @objc public var backgroundGradient: CAGradientLayer?
    ...
    */
    @objc public init(style: SwipeActionStyle, title: String?, handler: ((SwipeAction, IndexPath) -> Void)?) {
        self.title = title
        self.style = style
